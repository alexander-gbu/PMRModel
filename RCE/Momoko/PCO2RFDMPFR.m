...
D0co = 1e-1; %guessed
D0coliq = 1e3;
K = 0.01; % = kG*kL/(H*kL+kG) in cm/min mass transfer coeffienct for co in water 0.14 mm/s
...
figure()
surf(tspan, xspan(2:xmesh+1), C(2:xmesh+1, :), 'edgecolor', 'none');
xlabel('Time (min)');
